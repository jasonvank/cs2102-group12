...
\begin{tikzpicture}[node distance=1.5cm, every edge/.style={link}]
  ...
  \node[attribute] (rid) [below right=0.5cm of restaur] {\key{rid}} edge (restaur);
    \node[attribute] (closetime) [below right=2cm of restaur] {close\textunderscore time} edge (restaur.320);
  ...
  \node[relationship] (receives) [right=4cm of restaur] {Receives} edge (restaur);
    ...
    \node[relationship] (belongs) [above left=3cm of restaur] {Belongs} edge (restaur.90);
